...
Maintained by **[PSA Intelligence](https://github.com/psaintelligence)**.
...
- **Andrew Sampson** ([`@andrewmd5`](https://github.com/andrewmd5)) - this would not exist without his work on [ZeroPerl: Sandboxed Perl with WebAssembly](https://andrews.substack.com/p/zeroperl-sandboxed-perl-with-webassembly).
- **Phil Harvey** - the original [ExifTool](https://exiftool.org/).
